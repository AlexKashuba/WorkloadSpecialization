...
public:
  ...
  RC init_temp(table_t *host_table, uint64_t part_id, uint64_t row_id = 0);
...
struct row_storage {
  virtual void copyFrom(row_t *row) {}
  virtual void applyTo(row_t *row) {}
};
